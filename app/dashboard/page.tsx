...
export default function Page() {
  ...
  const [budgetData, setBudgetData] = useState<object[]>([]);
        ...
        <div>
          <div className="grid lg:grid-cols-3 gap-4">
            <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl ">
              ...
              <CircleDollarSign className="bg-yellow-500 w-9 h-9 rounded-full p-1 text-white" />
            </div>
            ...
            <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl ">
              ...
              <PiggyBank className="bg-yellow-500 w-9 h-9 rounded-full p-1 text-white" />
            </div>
            ...
            <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl ">
              ...
              <Landmark className="bg-yellow-500 w-9 h-9 rounded-full p-1 text-white" />
            </div>
          </div>

          <div className="w-full lg:flex mt-4">
            <div className="roundex-xl lg:w-2/3">
            ...
            <div className="lg:w-1/3 ml-4">
              <h3 className="text-lg font-semibold my-4 lg:mb-4 lg:mt-0">
                Derniers Budgets
              </h3>
